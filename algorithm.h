...
namespace Algorithm
{
  ...
  std::vector<int> getPartialMatchTable(const std::vector<unsigned char> &pattern)
  {
  ...
  int64_t ScanFor(int64_t StartAddress,std::vector<BYTE> bytearray,bool lastresult)
  {
    int64_t result=-1;
    size_t Size =3000;
